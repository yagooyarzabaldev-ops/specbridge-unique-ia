...
- Post-merge memory closure (issue 117): in progress as the evidence closure after PR 116 merged issue 115, recording CI completion, issue closure, and the next recommended apply-mode pilot task.
