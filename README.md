...
- Post-merge closure for issue 134 (issue 138): in progress as evidence closure recording combined apply-mode success and marking issue-134 scope completed. PR pending CI.
