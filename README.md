...
- Issue-to-merge GitHub evidence loop: in progress as the first governed end-to-end pilot that uses the `issue-to-merge-github` dry-run connector envelope for issue 115, then compares it with real GitHub issue, PR, CI, merge, issue closure, and memory evidence without changing the repository-local dry-run boundary.
