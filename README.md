...
- Intake bridge end-to-end test (issue 156): in progress as first external trigger of specbridge-intake.yml via gh workflow run, validating the full autonomous loop from ChatGPT entry point to merge.
