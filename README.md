...
- Post-merge closure and live pr_open demo (issue 125): in progress as the evidence closure after PR 124 merged issue 123, demonstrating apply-mode pr_open in live execution to create the PR for this branch. PR 125 pending CI.
