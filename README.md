...
- Live combined apply-mode demonstration (issue 134): in progress as the first governed combined execution of pr_open, merge, and issue_close in a single apply-mode call. Governance package prepared. PR 135 pending CI.
