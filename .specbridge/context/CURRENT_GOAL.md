...
| 126 | Apply-mode merge expansion | 129 | Pending CI |
...
After issue 126 merges: the apply-mode three-operation pilot (issue_close + pr_open + merge) is complete. Next: a live combined apply-mode demonstration running all three operations in a single governed call, or conclude the operator pilot series.
