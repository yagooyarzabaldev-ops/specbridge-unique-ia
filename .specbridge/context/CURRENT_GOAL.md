...
Issue 134 (live combined apply-mode demonstration): execute the first governed combined `issue-to-merge-github` apply-mode call with pr_open, merge, and issue_close in a single run.
...
Current phase is issue 134 live combined apply-mode demonstration (governance package prepared, PR 135 pending CI).
...
| 134 | Live combined apply-mode demonstration | 135 | Pending CI |

## Next Recommended Task

After issue 134 merges: consider a post-merge closure for issue 134, then plan the next operator expansion or conclude the pilot series.
