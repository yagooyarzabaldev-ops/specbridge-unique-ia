# Execution Contract: Issue 031

## Contract Metadata

- contract_id: issue-031-activate-schema-validation
- related_issue: https://github.com/yagooyarzabaldev-ops/specbridge/issues/31
...
Activate schema validation in the foundation workflow.

## Context

SpecBridge now defines schemas and needs a deterministic schema validation gate.
...
- CI passed.
- PR references and closes GitHub issue #31.
