# Execution Contract: Issue 021

## Contract Metadata

- contract_id: issue-021-claude-code-pr-review
- related_issue: https://github.com/yagooyarzabaldev-ops/specbridge/issues/21
...
Define the Claude Code pull request review standard.

## Context

SpecBridge needs review criteria before enabling automated Claude PR comments.
...
- CI passed.
- PR references and closes GitHub issue #21.
